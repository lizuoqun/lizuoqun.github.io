...
two-->C[定义数据字典]
C-->D[描述加工]
`}),a[2]||(a[2]=s('<p>可采用结构化自然语言、判定表和判定树描述加工</p><h3 id="结构化设计" tabindex="-1">结构化设计 <a class="header-anchor" href="#结构化设计" aria-label="Permalink to &quot;结构化设计&quot;">​</a></h3><p><strong>主要任务</strong>：在需求分析的基础上，定义满足需求所需要的结构，即针对给定的问题，给出该问题的软件解决方案，确定定“怎么做”的问题</p><h4 id="总体设计" tabindex="-1">总体设计 <a class="header-anchor" href="#总体设计" aria-label="Permalink to &quot;总体设计&quot;">​</a></h4><p><strong>基本任务</strong>：把系统的功能需求分配到一个特定软件体系结构中，建立系统的模块结构，只声明其作用或功能</p><p>Yourdon提出的模块结构图</p><image src="/My-Project/images/02333/Yourbon.png" data-fancybox="gallery" width="100%"></image><p>HIPO图【层次图+输入/处理/输出图】</p>',8)),n(t,{title:"带编号的层次图（H图）",showBorder:!0,code:`graph TD
A[正文加工系统]-->B1[输入1.0]
A-->B2[输入2.0]
A-->B3[编辑3.0]
A-->B4[加标题4.0]
...
B3--->C5[合并3.5]
B3--->C6[列表3.6]
`}),n(t,{title:"IPO图",showBorder:!0,code:`
graph LR
subgraph 输入
A[旧的主文件]
B[事务文件]
...
C --> F
D --> G
E --> H`}),a[3]||(a[3]=s("<p>其中：【有效的主记录--&gt;更新主记录、有效的事务记录--&gt;更新主记录】这个没在mermaid上画出来，画上去会导致图混乱</p><p>总体设计步骤</p><ul><li>系统的DFD图 <ul><li>变换型数据流图：具有较明显的输入部分和变换（或称主加工）部分之间的界面、变换部分和输出部分之间界面的DFD图</li><li>事务型数据流图：数据到达一个加工T，该加工T根据输入数据的值，在其后的<strong>若干动作序列</strong> （或称一个事务）中<strong>选出一个</strong>来执行。处理T称为事务中心，完成以下任务： <ul><li>接收输入数据</li><li>分析并确定对应的事务</li><li>选取与该事务对应的一条活动路径</li><li>事务型数据流图所描述系统的数据处理模式为<strong>集中一发散式</strong></li></ul></li></ul></li><li>初始的模块结构图【基于 高内聚低耦合 这一软件设计原理模块化】</li><li>最终的、可供详细设计使用的模块结构图</li></ul>",3)),n(e,{title:"交换【事务】设计的基本步骤",flowData:[{id:1,title:"设计准备",description:"复审并精化系统模型"},{id:2,title:"确定边界",description:"交换【确定输入、变换、输出这三部分之间的边界】<br/>事务【确定事务处理中心】"},{id:3,title:"第一级分解",description:"系统模块结构图顶层和第一层的设计"},{id:4,title:"第二级分解",description:"自顶向下，逐步求精"}]}),a[4]||(a[4]=s('<p>变换设计与事务设计的区别及联系</p><table><tr><td></td><td>区别（目的、组成、任务）</td><td>联系</td></tr><tr><td>变换设计</td><td>将变换型数据流图映射为模块结构图<br>组成：获取数据、变换数据（核心）和输出数据<br>设计一个主控模块来协调和控制其他模块，比较机械</td><td rowspan="2">以变换设计为主<br>事务设计为辅</td></tr><tr><td>事务设计</td><td>将事务型数据流图映射为模块结构图<br>事务中心需完成3个任务：<br>接收数据、分析并确定事务和选取活动路径</td><td></td></tr></table><p>耦合</p><ul><li>内容耦合：一个模块<strong>直接修改或操作</strong>另一个模块的数据。耦合程度最高，尽量避免使用</li><li>公共耦合：两个或两个以上的模块共同引用一个<strong>全局数据项</strong></li><li>控制耦合：一个模块通过接口向另一个模块传递<strong>一个控制信号</strong>（如开关、标志），接收信号的模块根据信号值进行适当的动作</li><li>标记耦合：模块A通过接口向模块B和C传递一个<strong>公共参数</strong>，称模块B和C间存在一个标记耦合</li><li>数据耦合：模块之间通过<strong>参数</strong>来传递数据。<strong>耦合程度最低，存在普遍</strong></li></ul><p>内聚</p><ul><li>偶然内聚：<strong>各成分之间不存在关系</strong></li><li>逻辑内聚：各成分逻辑上相关</li><li>时间内聚：各成分因时间因素关联在一起</li><li>过程内聚：模块内部处理成分相关且必须以特定次序处理</li><li>通信内聚：模块的所有程序都操作或生成同一数据集</li><li>顺序内聚：一个成分的输出作为另一个成分的输入</li><li>功能内聚：模块对完成其功能而言是充分必要的（<strong>最理想的</strong>）</li></ul><p>实现高内聚低耦合的<strong>启发式规则</strong>：</p><ul><li>改进软件结构，提高模块独立性；</li><li>力求模块规模适中(不超过60行)</li><li>力求深度、宽度、扇出和扇入适中（扇出3或4） <ul><li><strong>深度</strong>：控制的层数，粗略标志一个系统的规模和复杂程度</li><li><strong>宽度</strong>：同一个层次上模块总数的最大值（受扇出影响）</li><li><strong>扇入</strong>：表明有多少个上级模块直接调用它</li><li><strong>扇出</strong>：一个模块直接调用的下级模块数目</li></ul></li><li>尽力使模块的作用域在其控制域之内 <ul><li><strong>控制域</strong>：模块本身以及所有直接或间接从属于它的模块集合</li><li><strong>作用域</strong>：受该模块内一个判定所影响的所有模块的集合</li></ul></li><li>尽力降低模块接口的复杂度</li><li>力求模块功能可以预测</li></ul><h4 id="详细设计" tabindex="-1">详细设计 <a class="header-anchor" href="#详细设计" aria-label="Permalink to &quot;详细设计&quot;">​</a></h4><ul><li>目标：将总体设计阶段产生的系统<strong>高层结构</strong>映射为以这些术语所表达的<strong>低层结构</strong>，即系统的最终结构</li><li>任务：具体描述模块结构图中的每一个模块，即给出<strong>实现模块功能的实施机制</strong>，包括一组例程和数据结构，从而精确地定义了满足需求规约的结构</li><li>结构化程序设计方法：是一种基于结构的编程方法，采用<strong>顺序结构、选择结构以及重复结构</strong>进行编程，每一结构只允许一个入口和一个出口</li><li>工具：程序流程图（程序框图）、盒图(N-S图)、PAD图、类程序设计语言PDL</li></ul><h4 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h4>',11)),n(t,{code:`graph TB
A[结构化设计工具] --> B[总体设计工具]
A --> C[详细设计工具]
B--> D1[模块结构图]
B --> D2[层次图]
...
C--> E2[盒图]
C--> E3[PAD图]
C--> E4[PDL]`}),a[5]||(a[5]=s('<h2 id="面向对象方法-uml" tabindex="-1">面向对象方法 UML <a class="header-anchor" href="#面向对象方法-uml" aria-label="Permalink to &quot;面向对象方法 UML&quot;">​</a></h2><h3 id="uml术语表" tabindex="-1">UML术语表 <a class="header-anchor" href="#uml术语表" aria-label="Permalink to &quot;UML术语表&quot;">​</a></h3><h4 id="表达客观事物的术语" tabindex="-1">表达客观事物的术语 <a class="header-anchor" href="#表达客观事物的术语" aria-label="Permalink to &quot;表达客观事物的术语&quot;">​</a></h4><p>8个术语：<strong>类与对象、接口、协作、用况、主动类、构件、制品、节点</strong></p><h5 id="类与对象" tabindex="-1">类与对象 <a class="header-anchor" href="#类与对象" aria-label="Permalink to &quot;类与对象&quot;">​</a></h5>',5)),n(t,{title:"类与对象",showBorder:!0,code:`classDiagram
Animal : +int age
...
<span class="line"><span>end note</span></span>
<span class="line"><span></span></span>
<span class="line"><span>@enduml</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br></div></div></details><h4 id="顺序图" tabindex="-1">顺序图 <a class="header-anchor" href="#顺序图" aria-label="Permalink to &quot;顺序图&quot;">​</a></h4><p>是一种<strong>交互图</strong>，即由一组对象以及按时序组织的对象之间的关系组成，其中还包含这些对象之间所发送的消息</p><image src="/My-Project/images/02333/orderUml.png" data-fancybox="gallery" width="100%"></image><details class="details custom-block"><summary>PlantUML类图代码 <a href="https://www.plantuml.com/plantuml/uml" target="_blank" rel="noreferrer">在线预览</a></summary><div class="language-txt vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@startuml</span></span>
...
style G fill:#ffcccc,stroke:#cc0000`}),a[10]||(a[10]=s('<h3 id="软件生存周期模型" tabindex="-1">软件生存周期模型 <a class="header-anchor" href="#软件生存周期模型" aria-label="Permalink to &quot;软件生存周期模型&quot;">​</a></h3><h4 id="瀑布模型" tabindex="-1">瀑布模型 <a class="header-anchor" href="#瀑布模型" aria-label="Permalink to &quot;瀑布模型&quot;">​</a></h4><ul><li>概念：将软件生存周期的各项活动规定为按<strong>固定顺序</strong>而连接的若干阶段工作，形如瀑布流水，最终得到软件产品</li><li>作用：<strong>支持</strong>结构化软件开发、<strong>控制</strong>软件开发的复杂性、<strong>促进</strong>软件开发工程化</li><li>适用：需求已被很好的理解，且开发组织非常熟悉为实现这一模型所需要的过程</li></ul>',3)),n(t,{title:"瀑布模型各开发阶段的活动",code:`graph LR
A[系统需求] --> B[软件需求]
B --> C[需求分析]
C --> D[设计]
D --> E[编码]
...
E -.-> D
F -.-> E
G -.-> F`}),a[11]||(a[11]=s('<h4 id="增量模型" tabindex="-1">增量模型 <a class="header-anchor" href="#增量模型" aria-label="Permalink to &quot;增量模型&quot;">​</a></h4><ul><li>概念：指<strong>需求</strong>可以分组，形成一个个的<strong>增量</strong>，并可形成一个<strong>结构</strong>，即该模型有一个前提，需求可结构化，在此条件下，对每一增量实施 <strong>瀑布式开发</strong></li><li>适用：“技术驱动”的软件产品开发，常被工业界所采用</li><li>优点： <ul><li>第一个可交付版本需时间和成本较少</li><li>减少用户需求的变更</li><li>增量投资</li></ul></li><li>缺点： <ul><li>初始增量可能会造成后来增量的不稳定</li><li>一些增量就可能需要重新开发</li><li>增大管理成本</li></ul></li></ul>',2)),n(t,{title:"增量模型示意图",code:`graph LR
subgraph 增量1
...
增量1 --> 增量2 --> 增量3 --> N1[增量N
...] --> D[最终系统]`}),a[12]||(a[12]=s('<h4 id="演化模型" tabindex="-1">演化模型 <a class="header-anchor" href="#演化模型" aria-label="Permalink to &quot;演化模型&quot;">​</a></h4><ul><li>类型：迭代、增量式开发模型</li><li>概念 <ul><li>基础：用户提出待开发系统的核心需求</li><li>过程： <ul><li>根据需求，开发一个核心系统并投入运行，以便用户能够有效提出反馈</li><li>软件开发人员根据用户反馈</li><li>实施开发的迭代过程</li></ul></li></ul></li><li>选代：由需求、设计、编码、测试、集成组成</li><li>增量：通过增加或修正，产生软件产品的增量，最终完成软件产品的开发</li><li>适用：事先不能完整定义需求的软件</li></ul>',2)),n(t,{title:"增量模型示意图",code:`graph LR
subgraph 版本1
...
版本1 --> B[用户反馈] --> 版本2 --> D[用户反馈] --> 版本3 --> F[...持续演化]`}),a[13]||(a[13]=l("h4",{id:"螺旋模型",tabindex:"-1"},[i("螺旋模型 "),l("a",{class:"header-anchor",href:"#螺旋模型","aria-label":'Permalink to "螺旋模型"'},"​")],-1)),a[14]||(a[14]=l("ul",null,[l("li",null,[i("既念 "),l("ul",null,[l("li",null,"在瀑布模型和演化模型的基础上，加入两者忽略的风险分析"),l("li",null,"沿着螺旋线，经历制定计划，风险分析，实施工程，客户评估这4个方面的活动"),l("li",null,"自内向外每旋转一圈便产生一个更为完善的新版本")])]),l("li",null,"适用：项目的开发风险很大或客户不能确定系统需求")],-1)),n(t,{title:"螺旋模型示意图",code:`graph LR
subgraph 第1圈
...
S[开始] --> 第1圈 --> 第2圈 --> 第3圈 --> P4[...] --> E[最终系统]`}),a[15]||(a[15]=l("h4",{id:"喷泉模型",tabindex:"-1"},[i("喷泉模型 "),l("a",{class:"header-anchor",href:"#喷泉模型","aria-label":'Permalink to "喷泉模型"'},"​")],-1)),a[16]||(a[16]=l("ul",null,[l("li",null,"特征：迭代、无间隙"),l("li",null,"意义：说明了软件活动需要多次重复；活动之间没有明显的间隙"),l("li",null,"适用：面向对象技术的软件开发")],-1)),n(t,{title:"喷泉模型示意图",code:`graph TB
A[需求分析] --> B[面向对象分析 OOA]
B --> C[面向对象设计 OOD]
C --> D[面向对象编程 OOP]
D --> E[测试与维护]
...
B <-.-> C
C <-.-> D
D <-.-> E`}),a[17]||(a[17]=s('<h3 id="过程规划与管理" tabindex="-1">过程规划与管理 <a class="header-anchor" href="#过程规划与管理" aria-label="Permalink to &quot;过程规划与管理&quot;">​</a></h3><p>过程管理包括过程建立、过程评估和过程改进</p><h4 id="过程的建立" tabindex="-1">过程的建立 <a class="header-anchor" href="#过程的建立" aria-label="Permalink to &quot;过程的建立&quot;">​</a></h4><image class="my-2" src="/My-Project/images/02333/projectManagePlan.png" data-fancybox="gallery" width="100%"></image>',4)),n(e,{title:"选择软件生存周期模型（SLCM）的步骤",flowData:[{id:1,title:"No.1",description:"标识开发项目可用的SLCM"},{id:2,title:"No.2",description:"标识那些会影响SLCM选择的属性"},{id:3,title:"No.3",description:"标识为选择SLCM所需要的任何约束"},{id:4,title:"No.4",description:"评估所选择的SLCM"},{id:5,title:"No.5",description:"选择最能满足项目属性和约束的SLCM"}]}),a[18]||(a[18]=s('<h4 id="关于软件生存周期过程的监控" tabindex="-1">关于软件生存周期过程的监控 <a class="header-anchor" href="#关于软件生存周期过程的监控" aria-label="Permalink to &quot;关于软件生存周期过程的监控&quot;">​</a></h4><ul><li>软件生存周期过程——回答软件开发需要做哪些工作</li><li>软件生存周期模型——回答软件开发活动或任务如何组织</li><li>软件项目过程管理——回答软件过程如何管理 <ul><li>软件生存周期过程是软件生存周期模型和软件项目过程管理的基础</li><li>软件生存周期模型为软件项目过程管理提供支持</li></ul></li></ul><h2 id="集成化能力成熟度模型-cmmi" tabindex="-1">集成化能力成熟度模型 CMMI <a class="header-anchor" href="#集成化能力成熟度模型-cmmi" aria-label="Permalink to &quot;集成化能力成熟度模型 CMMI&quot;">​</a></h2><h3 id="背景与原理" tabindex="-1">背景与原理 <a class="header-anchor" href="#背景与原理" aria-label="Permalink to &quot;背景与原理&quot;">​</a></h3>',4)),n(t,{title:"集成化能力成熟度模型 Capability Maturity Model Integration for Development",code:`graph TB
A[集成化能力成熟度模型 CMMI] --> B[软件CMM]
A --> C[产品集成开发 CMM]
A --> D[系统工程 CMM]
`}),a[19]||(a[19]=s('<p>CMMI提出所基于的基本思想</p><ul><li>CMMI模型基于<strong>过程途径</strong>思想，把软件质量的3个支撑点：<strong>受训的人员</strong>、<strong>规程和方法</strong>、<strong>工具和设备</strong>进行集成，以开发所期望的系统产品</li><li>CMMI紧紧围绕<strong>开发</strong>、<strong>维护和运行</strong>，把经过证明的最佳实践放在一个结构中</li><li>该结构<strong>有助于</strong>指导组织确定其过程的改善优先次序；<strong>有助于</strong>指导这些改善的实施，以提高其过程能力和成熟度，还<strong>支持</strong> 其他领域能力成熟度模型的开发</li></ul><h3 id="cmmi的模型部件" tabindex="-1">CMMI的模型部件 <a class="header-anchor" href="#cmmi的模型部件" aria-label="Permalink to &quot;CMMI的模型部件&quot;">​</a></h3>',3)),n(t,{title:"CMMI的主要模型部件",code:`graph TB
A[过程域] --> B[意图陈述]
A --> C[简介性注释]
A --> D[相关过程域]
A --> E[专用目标] --> G{专用实践}
