...
two-->C[定义数据字典]
C-->D[描述加工]
`}),a[2]||(a[2]=s('<p>可采用结构化自然语言、判定表和判定树描述加工</p><h3 id="结构化设计" tabindex="-1">结构化设计 <a class="header-anchor" href="#结构化设计" aria-label="Permalink to &quot;结构化设计&quot;">​</a></h3><p><strong>主要任务</strong>：在需求分析的基础上，定义满足需求所需要的结构，即针对给定的问题，给出该问题的软件解决方案，确定定“怎么做”的问题</p><h4 id="总体设计" tabindex="-1">总体设计 <a class="header-anchor" href="#总体设计" aria-label="Permalink to &quot;总体设计&quot;">​</a></h4><p><strong>基本任务</strong>：把系统的功能需求分配到一个特定软件体系结构中，建立系统的模块结构，只声明其作用或功能</p><p><code>Yourdon</code>提出的模块结构图</p>',6)),n(r,{lazy:"",src:"/My-Project/images/02333/Yourbon.webp","data-fancybox":"gallery",width:"100%"}),a[3]||(a[3]=t("p",null,"HIPO图【层次图+输入/处理/输出图】",-1)),n(l,{title:"带编号的层次图（H图）",showBorder:!0,code:`graph TD
A[正文加工系统]-->B1[输入1.0]
A-->B2[输入2.0]
A-->B3[编辑3.0]
A-->B4[加标题4.0]
