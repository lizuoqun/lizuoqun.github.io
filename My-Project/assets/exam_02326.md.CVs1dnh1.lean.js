import{_ as o,C as t,c as d,o as p,aP as u,G as a,j as i,a as s}from"./chunks/framework.CcVWUnOI.js";const f=JSON.parse('{"title":"02326 操作系统 ✒️","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"exam/02326.md","filePath":"exam/02326.md","lastUpdated":1764835608000}'),c={name:"exam/02326.md"};function m(b,l,k,P,q,g){const e=t("MarkMermaid"),n=t("MarkLottie"),r=t("MarkAnnotate"),h=t("MarkTitle");return p(),d("div",null,[l[0]||(l[0]=u("",7)),a(e,{title:"计算机系统组成",showBorder:"true",code:`graph LR
A[计算机系统]-->B[软件系统]
A--> C[硬件系统]
B --> B1[应用软件]
...
B --> B3[系统软件]
B3 --> B31[操作系统、编译程序...]
C --> C1[CPU、内存、外存、I/O设备...]`}),l[1]||(l[1]=u("",29)),a(e,{code:`graph LR
