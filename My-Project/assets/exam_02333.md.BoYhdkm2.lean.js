import{_ as h,C as e,c as u,o as c,aP as s,G as n,j as t,a as i}from"./chunks/framework.BJOOWd-7.js";const T=JSON.parse('{"title":"02333 软件工程 ✒️","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"exam/02333.md","filePath":"exam/02333.md","lastUpdated":1758522919000}'),g={name:"exam/02333.md"};function m(_,a,k,q,P,y){const l=e("MarkMermaid"),r=e("el-image"),p=e("MarkFlow"),d=e("BackTop"),o=e("MarkTitle"),b=e("MarkLottie");return c(),u("div",null,[a[0]||(a[0]=s("",57)),n(l,{code:`graph LR
A([旅行社])--订票单-->B((预订机票))
Z[[航班目录]]--> B
B--航班-->C((准备机票))
B--费用-->Y((记账))
...
H --> K[子实践]
H --> L[共用实践的精化]
`}),a[29]||(a[29]=s("",14)),n(d),n(o,{color:"text-red-500",weight:500}),n(b,{path:"/My-Project/lottie/Programmer.json"})])}const A=h(g,[["render",m]]);export{T as __pageData,A as default};
