import{_ as b,C as e,c as h,o as u,aP as s,G as n,j as t,a as i}from"./framework.js";const x=JSON.parse('{"title":"02333 软件工程 ✒️","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"exam/02333.md","filePath":"exam/02333.md","lastUpdated":1760579576000}'),c={name:"exam/02333.md"};function g(m,a,_,q,k,P){const l=e("MarkMermaid"),r=e("el-image"),p=e("MarkFlow"),d=e("MarkTitle"),o=e("MarkLottie");return u(),h("div",null,[a[0]||(a[0]=s("",57)),n(l,{code:`graph LR
A([旅行社])--订票单-->B((预订机票))
Z[[航班目录]]--> B
B--航班-->C((准备机票))
B--费用-->Y((记账))
